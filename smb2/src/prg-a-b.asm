...
BonusChanceLayout:
	...
	.db $23, $89, $02, $AA, $AB
	.db $20, $C9, $0E, $78, $AC, $B0, $B4, $B7, $BA, $BC, $FB, $FB, $BF, $C2, $C5, $C9, $7C

	.db $20, $E8, $10
	.db $1C, $79, $AD, $B1, $B5, $B8, $BB, $BD, $BE, $FB, $C0, $C3, $C6, $CA, $7D, $1E

	.db $21, $08, $10
	.db $1D, $7A, $AE, $B2, $B6, $B9, $FB, $FB, $FB, $FB, $C1, $C4, $C7, $CB, $7E, $1F

	.db $21, $29, $03, $7B, $AF, $B3
	.db $21, $34, $03, $C8, $CC, $7F
